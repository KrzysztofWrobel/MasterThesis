...
%  % Just search for the "city" and you'll find them. TODO
  ...
  \university{\href{http://www.something.net}{Technishe Universität Berlin}}

  % The crest is a graphics file of the logo of your research institution.
  % Place it in ./0_frontmatter/figures and specify the width
  \crest{\includegraphics[width=4cm]{tub}}
...
\vspace{20mm}
\hspace{70mm}Signature from head of diploma defense committee:
...
\printglossary
\clearpage
%\printnomenclature[5cm] % [] = distance between entry and description
