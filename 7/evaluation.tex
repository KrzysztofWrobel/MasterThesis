...
\begin{figure}[h!]
  \begin{center}
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Total reconstruction execution time (4 images with resolution 1024x768pixels) in comparison to initial Sift feature number}
  \end{center}
\end{figure}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[mark=*,yellow] table[x=Number of Sift features,y=Known Rotations and Translations,col sep=comma] {ReconstructBA.csv};
        \legend{Standard 8-point initialization + Normal OpenCV Pose Estimation,Enhanced 8-point initialization + Normal Pose Estimation,Enhanced 8-point initiazliation + Enhanced Pose Estim, Alternative 3-point initiazliation + Normal Pose Estimation, Alternative 3-point initialization + Enhanced Pose Estimation, Known Rotations and Translations}
      \end{axis}
    \end{tikzpicture}
    \caption{Total execution time of reconstruction with Bundle Adjustment(4 images with resolution 1024x768pixels) in comparison to initial Sift feature number}
  \end{center}
\end{figure}
\clearpage
...
%    \label{fig:TODO}
%\end{figure}
\subsection{3D cloud reconstructed models}
