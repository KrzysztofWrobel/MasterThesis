...
Pursuant to Appendix 6 "Multiple View Geometry in Computer Vision"(A6.9.1 \cite{HartleyMultipleView}), the use of Rodigues parametrization for small angles (and noise in initial rotation matrices estimations can be expresed by small angles) the rotation matrix, and thus $R_{error}$, approximately equals to:
